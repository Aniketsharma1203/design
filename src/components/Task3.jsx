...
export const Task3 = () => {
  ...
  const handleNext = () => {
    setState((prev) => (prev + 2) % products.length);
    setState2((prev) => (prev + 2) % products.length);
  };

  const handlePrev = () => {
    setState((prev) => (prev - 2 + products.length) % products.length);
    setState2((prev) => (prev - 2 + products.length) % products.length);
  };
